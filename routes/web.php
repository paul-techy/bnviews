...
// Email confirmation route - accessible without authentication (for initial signup verification)
Route::get('users/confirm_email/{code?}', 'UserController@confirmEmail')->middleware('locale');

// Email verification code entry routes
Route::get('verify-email', 'UserController@showVerifyEmail')->middleware('locale');
Route::post('verify-email-code', 'UserController@verifyEmailCode')->middleware('locale');
